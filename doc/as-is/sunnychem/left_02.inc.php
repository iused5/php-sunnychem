...
&nbsp;
&nbsp;
<a href="dnload/dnload.inc.php?fn=dnload.PDF&fn2=sunnychem(Catalogue).PDF">
<font color=ff6600>
<b>
<u>
Sunnychem Catalogue download 
</u>
</b>
</font>
</a>
...
<?
 $left_array=array(
"sub_02_01.html?basename=02_01_01"=>"02_01",
"sub_02_01.html?basename=02_02_01"=>"02_02",
"sub_02_01.html?basename=02_03"=>"02_03"
 );
list($key,$val)=each($left_array);
foreach($left_array as $key=>$val){
 if($basename==$val){
